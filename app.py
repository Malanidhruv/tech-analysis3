...
def clean_and_display_data(data, strategy):
    ...
    if strategy == "Custom Price Movement":
        ...
        df["Candlestick_Patterns"] = df["Candlestick_Patterns"].astype(str)
...
strategy_descriptions = {
    "Price Action Breakout": """
        - Identifies both bullish breakouts and bearish breakdowns
        - Analyzes candlestick patterns and price action
        - Considers volume confirmation for pattern strength
        - Includes volume profile analysis
        - Shows breakout type (Bullish/Bearish/Neutral)
    """,
    "Volume Profile Analysis": """
